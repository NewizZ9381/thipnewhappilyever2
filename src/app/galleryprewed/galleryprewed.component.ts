...
@Component({
  selector: 'app-galleryprewed',
  templateUrl: './galleryprewed.component.html',
  styleUrls: ['./galleryprewed.component.css']
})
export class GalleryprewedComponent implements OnInit {
