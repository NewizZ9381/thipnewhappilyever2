...
@Component({
  selector: 'app-gallerywedrec',
  templateUrl: './gallerywedrec.component.html',
  styleUrls: ['./gallerywedrec.component.css']
})
export class GallerywedrecComponent implements OnInit {
